...
if (is_post() && req('btn') != 'delete' && req('btn') != 'upload_photos' && req('btn') != 'delete_photo') {
    $name  = req('name');
    $price = req('price');
    $stock = req('stock');
...
<form method="post" enctype="multipart/form-data" class="form">
    ...
    <?php if ($video_url):
        ...
        <div class="video-preview">
            <iframe src="https://www.youtube.com/embed/<?= encode($matches[1]) ?>" frameborder="0" allowfullscreen></iframe>
        </div>
    <?php endif; endif; ?>
